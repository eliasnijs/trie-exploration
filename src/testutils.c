...
#define TestUtils_RunMultiple(ts,a) testutils_run_multiple(ts, #a, a, sizeof(a)/sizeof(*(a)));
#define TestUtils_RunMultiple2(ts,a) testutils_run_multiple2(ts, #a, a, sizeof(a)/sizeof(*(a)));
...
struct TestUtilsTest {
	char *name;
	int (* run)(TestUtilsState *testutilsstate);
};

/* function declartations */
#if TESTUTILS_ENABLE_TUI
static void testutils_tui(char *name, TestUtilsTest *tests, int testcount);
static void testutils_tui_handle_input(char *input, TestUtilsTest *tests,
				       int32 testcount, int32 *selected_index);
static void testutils_tui_render_select(WINDOW *win, TestUtilsTest *tests,
					int32 testcount, int32 *selected_index);
static void testutils_tui_render_output(WINDOW *win);
#endif
static int  testutils_run_single(TestUtilsState *testutils, TestUtilsTest *test);
static int  testutils_run_multiple(TestUtilsState *testutilsstate, char *name,
				   TestUtilsTest tests[], int testc);
static int  testutils_run_multiple2(TestUtilsState *testutilsstate, char *name,
				    TestUtilsTest tests[], int testc);
...
static void
testutils_tui(char *name, TestUtilsTest *tests, int testcount)
{
